...
void StraightLineObject::move(){
    vertices[0] -= direction[0]/5;
    vertices[1] -= direction[1]/5;
    vertices[2] -= direction[0]/5;
    vertices[3] -= direction[1]/5;
    vertices[4] -= direction[0]/5;
    vertices[5] -= direction[1]/5;
    // transform = glm::translate(transform, glm::vec3(-direction[0]/1000, -direction[1]/1000, 0.0f));
}